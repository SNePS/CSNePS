...
public class TermNode<E extends IEdge> implements ITermNode<E> {
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getTerm()
	 */
	@Override
	public Term getTerm(){
		return term;
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getInEdges()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#addInEdge(csneps.gui.graph.Edge)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getOutEdges()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#addOutEdge(csneps.gui.graph.Edge)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#isVisible()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#show()
	 */
	@Override
	public void show(){
		visible = true;
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#hide()
	 */
	@Override
	public void hide(){
		visible = false;
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getDownCablesetVisibleCount()
	 */
	@Override
    ...
    /* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#isDownCablesetVisible()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#isDownCablesetPartialVisible()
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getUpCablesetVisibleCount()
	 */
	@Override
    ...
    /* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#isUpCablesetVisible()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#isUpCablesetPartialVisible()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getInEdgesMinusFS()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see csneps.gui.graph.ITermNode#getRelationsPartOf()
	 */
    @Override
