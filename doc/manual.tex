...
\docfun{list-terms}{\&key (:asserted nil) (:types nil) (:originsets nil)}
Prints a list of all the terms in the KB.  If \texttt{:asserted} is non-nil,
only asserted propositions will be printed; otherwise, all terms will
be printed.  If \texttt{:types} is non-nil, the type of
each term will also be printed. If \texttt{:originsets} is non-nil, the origin sets of each term will also be printed.
...
\docfun{snip/print-all-waiting-msgs}{}
Prints all messages waiting in any channels in the IG.
