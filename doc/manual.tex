...
\docfun{list-terms}{\&key (:asserted nil) (:types nil) (:originsets nil) (:properties nil) (:showontology nil)}
Prints a list of all the terms in the KB, except ontological terms in the OntologyCT context. These may be seen by setting \texttt{:showontology} non-nil.  If \texttt{:asserted} is non-nil,
